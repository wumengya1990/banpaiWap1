<template>
  <div class="newCourse mianScroll bgmain">
      ...
      <div class="establishBox">
        ...
        <ul>
          <li>
            ...
            <div class="overHide">
              <el-input v-model="inputWZ" placeholder="请输入内容"></el-input>
            </div>
          </li>
          <li>
            <em>
            ...
            <div class="overHide">
              <el-input v-model="inputMC" placeholder="请输入内容"></el-input>
            </div>
          </li>
          <li>
            <em>课时数</em>
    ...
    <div class="establishBut">
      <el-button type="primary" round @click="submitForm()">保存教案</el-button>
    </div>
  </div>
</template>
